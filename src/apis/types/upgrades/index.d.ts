import { UpgradeKey as _UpgradeKey } from "./UpgradeKey";
import { UpgradeInfo as _UpgradeInfo } from "./UpgradeInfo";
...
export declare type BuyUpgradeData = _BuyUpgradeData;
export declare type GuestUpgradeData = _GuestUpgradeData;
export declare type GuestBuyUpgradeData = _GuestBuyUpgradeData;
export declare type UpgradeInfoWithGold = _UpgradeInfoWithGold;